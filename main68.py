...
val='10.11.2025'
data=datetime.strptime(val,'%d.%m.%Y')
print(data)
...
def get_upcoming_birthdays(book, days=7):
    ...
    for name in book:
        ...
        birthday_this_year = book[name].birthday.replace(year=today.year)
        if birthday_this_year<today:
            birthday_this_year=book[name].birthday.replace(year=today.year+1)
